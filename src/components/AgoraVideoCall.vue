  ...
  <div id="ag-canvas">
    <div class="ag-btn-group">
      ...
      <span v-if="attendeeMode === 'video'"
        ...
        <i v-if="camera" @click="camera = false" class="mdi mdi-camera"></i>
        <i v-if="camera == false" @click="camera = true" class="mdi mdi-camera-off"></i>
      </span>
      <span v-if="attendeeMode !== 'audience'"
        @click="handleMic"
        class="ag-btn audioControlBtn" 
        title="Enable/Disable Audio">
        <i v-if="camera2" @click="camera2 = false" class="mdi mdi-camera"></i>
        <i v-if="camera2 == false" @click="camera2 = true" class="mdi mdi-camera-off"></i>
      </span>
      <span 
        @click="switchDisplay"
